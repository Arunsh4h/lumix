	...
	if (!isset( $askme_updater)) {
		...
		$askme_updater = new ElitePack_Theme_Updater_Admin(
			...
			$config = array(
				...
				'item_id'          => '7935874',
				'name'             => 'Ask Me - Responsive Questions & Answers WordPress',
...
function askme_registeration_menu() {
	...
	if ($support_activate) {
		...
		add_menu_page('Register Ask Me','Register Ask Me','manage_options','registration','askme_registeration_page','dashicons-admin-site');
	}
}
