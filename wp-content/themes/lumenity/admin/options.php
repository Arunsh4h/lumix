...
function askme_admin_options() {
	...
	$options[] = array(
		...
		'desc' => esc_html__("Add it professional email, like no_reply@2code.info","vbegy"),
		'id'   => 'email_template',
	...
	$options[] = array(
		...
		'std'  => '&copy; '.date('Y').' Ask Me. All Rights Reserved<br>With Love by <a href="https://2code.info/" target="_blank">2code</a>.',
		'type' => 'textarea'
	);
	...
	$options[] = array(
		...
		'std' => 'Copyright '.date('Y').' Ask me | <a href=https://2code.info/>By 2code</a>',
		'type' => 'textarea');
