...
if ($support_activate) {
	...
	function askme_import_files() {
		...
		if (array_key_exists('page',$_GET) && $_GET['page'] == 'demo-import') {
			$file_path = "https://2code.info/demos.php?demo=ask-me";
			if ($file_path != "") {
	...
	function askme_after_import_setup($selected_import) {
		...
		$own_url = 'https://2code.info/demo/themes/ask-me/';
		$own_url_2 = 'https://2code.info/demo/themes/ask-me/rtl/';
		$own_url_3 = 'https://2code.info/demo/themes/ask-me/shop/';
