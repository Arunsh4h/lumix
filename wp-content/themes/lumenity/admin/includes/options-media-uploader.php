...
class askme_media_uploader {
	...
	public function init() {
		add_action( 'admin_enqueue_scripts', array( $this, 'askme_scripts' ) );
	}
	...
	static function askme_uploader($_id,$_value,$_desc = '',$_name = '',$no_id_name = '',$options = array()) {
	 ...
	 */
	function askme_scripts() {

		if ( function_exists( 'wp_enqueue_media' ) )
			wp_enqueue_media();

		wp_register_script( 'of-media-uploader', askme_framework_dir .'js/media-uploader.js', array( 'jquery' ) );
