								...
								<div class="section_inner_container">
									<div class="row section_inner">
										<div class="col col7"> 
											...
											<div class="main_section_left_content main_section_content">Test Ask Me application demo on Google Play and App Store.</div>
										</div>
										<div class="col col5">
											<div class="row">
				...
				<div class="optionsframework-content">
				    ...
				    <div id="optionsframework-metabox" class="metabox-holder">
					    <div id="optionsframework" class="postbox">
							...
							<div id="ajax-load"><i class="dashicons dashicons-info"></i><?php esc_html_e("Loading the page and reclick on the button again","vbegy")?></div>
						</div> <!-- / #container -->
					</div>
