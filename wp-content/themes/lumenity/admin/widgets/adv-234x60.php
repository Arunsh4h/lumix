	...
	function form( $instance ) {
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id( 'adv_link' ); ?>" name="<?php echo $this->get_field_name( 'adv_link' ); ?>">
				<option value="same_page" <?php if( isset($instance['adv_link']) && $instance['adv_link'] == 'same_page' ) echo "selected=\"selected\""; else echo ""; ?>><?php esc_html_e("Same page","vbegy")?></option>
				<option value="new_page" <?php if( isset($instance['adv_link']) && $instance['adv_link'] == 'new_page' ) echo "selected=\"selected\""; else echo ""; ?>><?php esc_html_e("New page","vbegy")?></option>
			</select>
		</p>
