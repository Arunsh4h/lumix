...
class Widget_Questions extends WP_Widget
{
	...
	function __construct()
	{
		...
		parent::__construct('questions-widget', 'Lumeno - Questions or posts', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		$questions_per_page = (isset($instance['questions_per_page']) ? (int)$instance['questions_per_page'] : '');
		$display_date       = (isset($instance['display_date']) ? esc_html($instance['display_date']) : '');
		$display_image      = (isset($instance['display_image']) ? esc_html($instance['display_image']) : '');
		$display_author     = (isset($instance['display_author']) ? esc_attr($instance['display_author']) : '');
		$questions_excerpt  = (isset($instance['questions_excerpt']) ? (int)$instance['questions_excerpt'] : '');
		$excerpt_title      = (isset($instance['excerpt_title']) ? (int)$instance['excerpt_title'] : '');
...
?>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('orderby'); ?>" name="<?php echo $this->get_field_name('orderby'); ?>">
				<option value="popular" <?php if (isset($instance['orderby']) && $instance['orderby'] == 'popular') echo "selected=\"selected\"";
										else echo ""; ?>>Popular</option>
				<option value="recent" <?php if (isset($instance['orderby']) && $instance['orderby'] == 'recent') echo "selected=\"selected\"";
										else echo ""; ?>>Recent</option>
				<option value="random" <?php if (isset($instance['orderby']) && $instance['orderby'] == 'random') echo "selected=\"selected\"";
										else echo ""; ?>>Random</option>
				<option value="no_response" <?php if (isset($instance['orderby']) && $instance['orderby'] == 'no_response') echo "selected=\"selected\"";
											else echo ""; ?>>No response </option>
			</select>
		</p>
		<p>
