...
class Widget_Questions_Categories extends WP_Widget
{
	...
	function __construct()
	{
		...
		parent::__construct('questions_categories-widget', 'Lumeno - Questions Categories', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		$questions_counts = (isset($instance['questions_counts']) ? esc_attr($instance['questions_counts']) : '');
		$show_child       = (isset($instance['show_child']) ? esc_attr($instance['show_child']) : '');
