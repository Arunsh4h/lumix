...
class Widget_Flickr extends WP_Widget
{
	...
	function __construct()
	{
		...
		parent::__construct('flickr-widget', 'Lumeno - Flickr', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		$no_of_flickr = (isset($instance['no_of_flickr']) ? (int)$instance['no_of_flickr'] : '');
	...
	function form($instance)
	{
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id('accounts'); ?>" name="<?php echo $this->get_field_name('accounts'); ?>" value="<?php if (isset($instance['accounts']) && !empty($instance['accounts'])) {
																																				echo esc_attr($instance['accounts']);
