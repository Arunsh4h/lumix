...
class Latest_Tweets extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'twitter_widget','Lumeno - Twitter', $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			<div class="widget_twitter">
				...
				$tweets = get_transient('vpanel_twitter_widget_'.$rand_w.$accounts);
				if ($tweets == false) {
					$tweets = vpanel_twitter_tweets($accounts,$no_of_tweets);
					set_transient('vpanel_twitter_widget_'.$rand_w.$accounts, $tweets, HOUR_IN_SECONDS);
				}
