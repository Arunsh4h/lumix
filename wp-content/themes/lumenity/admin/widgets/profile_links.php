...
class Widget_Profile extends WP_Widget
{
	...
	function __construct()
	{
		...
		parent::__construct('profile-widget', 'Lumeno - Profile', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		if (is_user_logged_in) {
			...
			<div class="widget_profile">
				<?php $active_points = askme_options("active_points");
				$user_links = askme_options("user_links");
