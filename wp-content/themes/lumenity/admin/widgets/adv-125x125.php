...
class Widget_Adv125x125 extends WP_Widget
{
	...
	function __construct()
	{
		...
		parent::__construct('adv125x125-widget', 'Lumeno - Adv 125x125', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('adv_link_1'); ?>" name="<?php echo $this->get_field_name('adv_link_1'); ?>">
				<option value="same_page" <?php if (isset($instance['adv_link_1']) && $instance['adv_link_1'] == 'same_page') echo "selected=\"selected\"";
											else echo ""; ?>><?php esc_html_e("Same page", "vbegy") ?></option>
				<option value="new_page" <?php if (isset($instance['adv_link_1']) && $instance['adv_link_1'] == 'new_page') echo "selected=\"selected\"";
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('adv_link_2'); ?>" name="<?php echo $this->get_field_name('adv_link_2'); ?>">
				<option value="same_page" <?php if (isset($instance['adv_link_2']) && $instance['adv_link_2'] == 'same_page') echo "selected=\"selected\"";
											else echo ""; ?>><?php esc_html_e("Same page", "vbegy") ?></option>
				<option value="new_page" <?php if (isset($instance['adv_link_2']) && $instance['adv_link_2'] == 'new_page') echo "selected=\"selected\"";
											else echo ""; ?>><?php esc_html_e("New page", "vbegy") ?></option>
			</select>
		</p>
		<em style="display:block; border-bottom:1px solid #CCC; margin-bottom:15px;">OR</em>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('adv_link_3'); ?>" name="<?php echo $this->get_field_name('adv_link_3'); ?>">
				<option value="same_page" <?php if (isset($instance['adv_link_3']) && $instance['adv_link_3'] == 'same_page') echo "selected=\"selected\"";
											else echo ""; ?>><?php esc_html_e("Same page", "vbegy") ?></option>
				<option value="new_page" <?php if (isset($instance['adv_link_3']) && $instance['adv_link_3'] == 'new_page') echo "selected=\"selected\"";
											else echo ""; ?>><?php esc_html_e("New page", "vbegy") ?></option>
			</select>
		</p>
		<em style="display:block; border-bottom:1px solid #CCC; margin-bottom:15px;">OR</em>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('adv_link_4'); ?>" name="<?php echo $this->get_field_name('adv_link_4'); ?>">
				<option value="same_page" <?php if (isset($instance['adv_link_4']) && $instance['adv_link_4'] == 'same_page') echo "selected=\"selected\"";
											else echo ""; ?>><?php esc_html_e("Same page", "vbegy") ?></option>
				<option value="new_page" <?php if (isset($instance['adv_link_4']) && $instance['adv_link_4'] == 'new_page') echo "selected=\"selected\"";
											else echo ""; ?>><?php esc_html_e("New page", "vbegy") ?></option>
			</select>
		</p>
		<em style="display:block; border-bottom:1px solid #CCC; margin-bottom:15px;">OR</em>
