	...
	function form( $instance ) {
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id( 'video_type' ); ?>" name="<?php echo $this->get_field_name( 'video_type' ); ?>">
				...
				<option value="facebook" <?php if( isset($instance['video_type']) && $instance['video_type'] == 'facebook' ) echo "selected=\"selected\""; else echo ""; ?>>Facebook</option>
				<option value="tiktok" <?php if( isset($instance['video_type']) && $instance['video_type'] == 'tiktok' ) echo "selected=\"selected\""; else echo ""; ?>>TikTok</option>
			</select>
		</p>
		<p>
