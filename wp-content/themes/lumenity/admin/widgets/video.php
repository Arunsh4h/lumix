...
class Widget_Video extends WP_Widget
{
	...
	function __construct()
	{
		...
		parent::__construct('video-widget', 'Lumeno - Video', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		if ($embed_code) :
			...
			$type = askme_video_iframe($video_type, $video_id);
	...
	function form($instance)
	{
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('video_type'); ?>" name="<?php echo $this->get_field_name('video_type'); ?>">
				<option value="youtube" <?php if (isset($instance['video_type']) && $instance['video_type'] == 'youtube') echo "selected=\"selected\"";
										else echo ""; ?>>Youtube</option>
				<option value="vimeo" <?php if (isset($instance['video_type']) && $instance['video_type'] == 'vimeo') echo "selected=\"selected\"";
										else echo ""; ?>>Vimeo</option>
				<option value="daily" <?php if (isset($instance['video_type']) && $instance['video_type'] == 'daily') echo "selected=\"selected\"";
										else echo ""; ?>>Dialymotion</option>
				<option value="facebook" <?php if (isset($instance['video_type']) && $instance['video_type'] == 'facebook') echo "selected=\"selected\"";
											else echo ""; ?>>Facebook</option>
				<option value="tiktok" <?php if (isset($instance['video_type']) && $instance['video_type'] == 'tiktok') echo "selected=\"selected\"";
										else echo ""; ?>>TikTok</option>
			</select>
		</p>
		<p>
