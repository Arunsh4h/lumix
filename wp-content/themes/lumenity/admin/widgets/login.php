...
class Widget_Login extends WP_Widget
{
	...
	function __construct()
	{
		...
		parent::__construct('login-widget', 'Lumeno - Login', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		$not_login            = (isset($instance['not_login']) ? esc_html($instance['not_login']) : '');
		$register_like_button = (isset($instance['register_like_button']) ? esc_html($instance['register_like_button']) : '');
		if (empty($not_login) || !is_user_logged_in) {
			...
			<div class="widget_login">
				<?php if (!is_user_logged_in) {
					...
					echo is_user_logged_in_data(askme_options("user_links")) . '<div class="clearfix"></div>';
				} ?>
			</div>
		<?php
			echo $after_widget;
