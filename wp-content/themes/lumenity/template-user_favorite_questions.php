...
get_header();
	...
	<div class="page-content page-content-user">
		<div class="user-questions">
			...
			if ($custom_permission != 1 || (is_super_admin($user_login->ID) || (is_user_logged_in && isset($roles["favorite_question"]) && $roles["favorite_question"] == 1))) {
				...
				if (isset($_favorites) && is_array($_favorites) && count($_favorites) >= 1) {
					...
					$args = array_merge($author__not_in,array('post_type' => ask_questions_type,'posts_per_page' => $rows_per_page,'paged' => $paged,'post__in' => $_favorites));
					query_posts($args);
