...
get_header();
	...
	<div class="page-content page-content-user">
		<div class="user-questions">
			...
			$paged = askme_paged();
			$args = array('post_type' => ask_questions_type,'posts_per_page' => $rows_per_page,'paged' => $paged,'author' => $user_login->ID,"meta_query" => array(array("key" => "question_poll","compare" => "=","value" => 1)));
			query_posts($args);
