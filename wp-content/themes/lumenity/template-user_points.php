							...
							<div class="question-content">
								<div class="question-bottom">
									<div class="question-meta-first">
										...
										<?php }
											if ($point_result[4] != "ask_points" && $point_result[4] != "sticky_points" && $point_result[4] != "rating_question" && $point_result[4] != "polling_question" && $point_result[4] != "rating_answer" && $point_result[4] != "user_unfollow" && $point_result[4] != "user_follow" && $point_result[4] != "bump_question" && $point_result[4] != "select_best_answer" && $point_result[4] != "cancel_best_answer" && $point_result[4] != "answer_question" && $point_result[4] != "add_question" && $point_result[4] != "add_post" && $point_result[4] != "question_point" && $point_result[4] != "gift_site" && $point_result[4] != "admin_add_points" && $point_result[4] != "admin_remove_points" && $point_result[4] != "point_back" && $point_result[4] != "point_removed" && $point_result[4] != "delete_answer" && $point_result[4] != "delete_best_answer" && $point_result[4] != "delete_follow_user" && $point_result[4] != "rewarded_adv") {
												echo $point_result[4];
											}else if ($point_result[4] == "rating_question") {
												_e("Rating your question.","vbegy");
											}else if ($point_result[4] == "polling_question") {
												_e("Polled a question.","vbegy");
											...
											}else if ($point_result[4] == "ask_points") {
												_e("You have bought to ask question by points","vbegy");
											}else if ($point_result[4] == "sticky_points") {
												_e("You have stickied your question by points","vbegy");
												...
												_e("Delete your following user.","vbegy");
											}else if ($point_result[4] == "rewarded_adv") {
												_e("Get points from the rewarded adv.","vbegy");
											}
										if (!empty($point_result[5]) && !empty($point_result[6]) && $get_post_status != "trash" && isset($get_comment) && $get_comment->comment_approved != "spam" && $get_comment->comment_approved != "trash") {?>
											</a>
										<?php }else if (!empty($point_result[5]) && empty($point_result[6]) && $get_post_status != "trash" && isset($get_the_permalink) && $get_the_permalink != "") {?>
